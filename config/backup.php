...
return [
    ...
    'notifications' => [
        'notifications' => [
            ...
            BackupWasSuccessfulNotification::class => ['mail', 'discord'],
            HealthyBackupWasFoundNotification::class => ['mail', 'discord'],
            CleanupWasSuccessfulNotification::class => ['mail', 'discord'],
        ],
        ...
        'mail' => [
            ...
            'from' => [
                'address' => env('MAIL_FROM_ADDRESS', 'thefoxybg@gmail.com'),
                'name' => env('MAIL_FROM_NAME', 'hsabev'),
            ],
        ],
